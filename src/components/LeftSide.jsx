...
function LeftSide() {
  ...
  return (
    <div className="bg-[#F8FAFC] h-[300vh] flex-direction-row Justify-Between media-height media-height-M flex flex-col gap-7 my-5 py-3 px-3 items-center ml-5 rounded-2xl">
      <div className="logo text-[1.2rem] font-bold">ZuAi</div>
      <div className={`${isMobileView ? "block" : "hidden"}`}>
        {navBarHumBurgur ? (
          <RxCross1
            onClick={() => {
              setNavBarHumBurgur(false);
            }}
